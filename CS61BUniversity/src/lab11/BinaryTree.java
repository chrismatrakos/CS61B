...
public class BinaryTree implements Dictionary {
	...
	public Entry remove(Object key) {
		...
		if (isExternal(node)) {
			...
			BinaryTreeNode min = findMin(node.rightChild);
	...
	private boolean isExternal(BinaryTreeNode node) {
	...
	private boolean oneChild(BinaryTreeNode node) {
